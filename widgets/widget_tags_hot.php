...
?>
<?php
class widget_tags_hot extends WP_Widget {

    function __construct(){
        parent::__construct( 'widget_tags_hot', __('QGG 热门标签', 'QGG'), array( 'classname' => 'widget-tags-hot', 'description'=> '热门标签、显示数量、标签限制、更多链接' ) );
    }
    ...
    function widget( $args, $instance ) {
        ...
        echo '<div class="tags site-style-childA-hover-background-color">';
