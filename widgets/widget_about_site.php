...
class widget_about_site extends WP_Widget{
	...
	function widget( $args, $instance ){
		...
		echo '<p>'.$content.'</p>';
		echo '<ul>
				<li><span>文章</span><b class="site-skin-color">'.$postcount->publish.'</b></li>
				<li><span>评论</span><b class="site-skin-color">'.$commtcount.'</b></li>
				<li><span>标签</span><b class="site-skin-color">'.$tagcount.'</b></li>
				<li><span>用户</span><b class="site-skin-color">'.$usercount.'</b></li>
			</ul>';
		echo '</div>';
		echo $after_widget;
	}
