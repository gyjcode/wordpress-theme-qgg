    ...
    echo '<div class="author-info site-style-childA-hover-color">';
        ...
        echo '<div class="sns">';
            ...
            if( get_the_author_meta( "qq" ) ){
                echo '<span class="sns-item">
                    <a href="'.get_the_author_meta( "qq" ).'" rel="nofollow" target="_blank"><i class="fal fa-qq"></i><b>QQ</b></a>
                </span>';
            }
            if( get_the_author_meta( "wechat" ) ){
                echo '<span class="sns-item">
                    <a href="'.get_the_author_meta( "wechat" ).'" rel="nofollow" target="_blank"><i class="fal fa-weixin"></i><b>微信</b></a>
                </span>';
            }    
            if( get_the_author_meta( "weibo" ) ){
                echo '<span class="sns-item">
                    <a href="'.get_the_author_meta( "weibo" ).'" rel="nofollow" target="_blank"><i class="fal fa-weibo"></i><b>微博</b></a>
                </span>';
            }
            if( get_the_author_meta( "email" ) ){
                echo '<span class="sns-item">
                    <a href="'.get_the_author_meta( "email" ).'" rel="nofollow" target="_blank"><i class="fal fa-envelope"></i><b>邮箱</b></a>
                </span>';
            }
        echo '</div>';
        }
