...
function wechat_official_captcha(){
	...
	$min     = floor(date("i")/WECHAT_OFFICIAL_CAPTCHA_TIME);
	$day     = date("d");
	$day     = ltrim($day,0);
	$url     = home_url();
	$captcha = sha1($min.$url.WECHAT_OFFICIAL_TOKEN);
...
function wechat_official_captcha_shortcode($atts, $content=null) {
	...
	<div id="wechat-official-captcha">
	   <div class="main">
			<div class="qrcode">
				<img src="'.WECHAT_OFFICIAL_QRCODE.'" alt="扫码关注公众号">
			</div>
			<div class="text">
				<div class="tips">
					<p>本段内容已被隐藏，您需要扫码关注微信公众号，发送【<span>验证码</span>】获取最新验证码查看。</p>
					<p class="prinmary">注意：验证码<b>'.WECHAT_OFFICIAL_CAPTCHA_TIME.'</b>分钟内有效！</p>
				</div>
				<div class="ipt">
