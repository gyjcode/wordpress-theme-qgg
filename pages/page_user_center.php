...
<?php if( !QGG_Options('user_center_open') ) exit('该功能需要开启！！！'); ?>

<section class="container">
	<div id="user-center"<?php echo is_user_logged_in() ? '' : ' class="is-sign-show" style="height:500px;"' ?>>
		<!-- 用户中心侧边栏 -->
		<div class="sidebar" style="<?php echo $borderRadius; ?>">
			...
			<div class="user-menus">	
				<ul class="user-menu">
					<?php if( QGG_Options('user_publish_open') ){ ?>
					<li class="user-menu-publish <?php echo QGG_Options('user_publish_open') && !QGG_Options('user_erphpdown_open') ? 'm-menu' : ''; ?>"><a href="#publish"><i class="iconfont qgg-edit"></i><span>我要</span>投稿</a></li>
					<?php } ?>
					
					<li class="user-menu-posts m-menu"><a href="#posts/all"><i class="iconfont qgg-copy"></i><span>我的</span><b>文章</b></a></li>
					<li class="user-menu-comments <?php echo !QGG_Options('user_erphpdown_open') ? 'm-menu' : ''; ?> "><a href="#comments"><i class="iconfont qgg-message"></i><span>我的</span>评论</a></li>
					
					<?php if( QGG_Options('user_erphpdown_open') ){ ?>
					<!-- 集成 Erphpdown -->		
					...
					<li class="user-menu-signout <?php echo QGG_Options('user_publish_open') || QGG_Options('user_erphpdown_open') ? '' : 'm-menu'; ?> "><a href="<?php echo wp_logout_url(home_url()) ?>"><i class="iconfont qgg-sharing_box_filled"></i>退出</a></li>
				</ul>
			</div>
		</div>
		<!-- 用户中心内容区 -->
		<div class="content" style="<?php echo $borderRadius; ?>">
			<div id="content-frame">
				...
				<?php 
				if( QGG_Options('user_erphpdown_open') ){ 
...
<!-- Erphpdown -->
<?php if( QGG_Options('user_erphpdown_open') && function_exists('recharge_money') ){ ?>
	...
	<form enctype="multipart/form-data">
	  	<ul class="user-meta">
			<li class="user-avatar">
				...
				<?php echo _get_the_avatar($user_id=$current_user->ID, $user_email=$current_user->user_email, $src = true, $size = 100) ; ?>
				</div>
