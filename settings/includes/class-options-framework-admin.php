...
class Options_Framework_Admin {
	...
	static function menu_settings() {
		...
		$menu = array(
            ...
            'page_title' => __( '主题设置', 'QGG' ),
			'menu_title' => __( '主题设置', 'QGG' ),
     ...
     */
	 function options_page() { ?>
		...
		<h2><?php echo esc_html( $menu['menu_title'] ); ?></h2>

		<div class="optionsframework-sidebar">
	...
	function validate_options( $input ) {
		...
		if ( isset( $_POST['reset'] ) ) {
			add_settings_error( 'options-framework', 'restore_defaults', __( '所有主题选项已初始化！', 'QGG' ), 'updated fade' );
	...
	function save_options_notice() {
		add_settings_error( 'options-framework', 'save_options', __( '保存设置成功！', 'QGG' ), 'updated fade' );
	}
