...
<section class="product-info container site-style-border-radius">
    <div class="product-info-img">
        <div class="img-main">
            <?php echo _get_the_post_thumbnail(); ?>
        </div>
        <div class="img-list">
            <ul>
                <li>
    ...
    <div class="product-info-content">
        <div class="title">
            <h1><a href="<?php the_permalink(); ?>"><?php the_title(); ?><?php echo _get_the_post_subtitle(); ?></a></h1>
        </div>
        <?php
        echo '<div class="meta">';
...
<div class="container">
    <div class="content">
        <section class="main site-style-border-radius">
            ...
            <?php } ?>
            <!-- 文章底部文字广告 -->
            <?php if (QGG_Options('ads_text_post_footer_on')) {
